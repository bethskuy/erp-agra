        ...
        <div class="row items-center no-wrap">
          ...
          <div>
            ...
            <div class="text-subtitle1 text-grey-7 q-mt-sm">
              Gudang ID:
              <q-badge color="indigo-1" text-color="indigo-10" class="q-px-sm text-weight-bold">{{
                gudangId || 'UTAMA'
              }}</q-badge>
            </div>
          </div>
              ...
              >
                <div v-if="form.barang" class="row q-col-gutter-md q-mb-md">
                  <div class="col-12 col-sm-4">
                    <div class="comparison-card bg-blue-1">
                      <div class="text-caption text-indigo-9 text-weight-bold uppercase">
                        Stok Sistem
                      </div>
                  ...
                  <div class="col-12 col-sm-4">
                    <div class="comparison-card bg-grey-2">
                      ...
                      <div class="text-h5 text-weight-black text-primary">{{ form.stokFisik }}</div>
                      <div class="text-caption">{{ form.barang.satuan }}</div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-4">
