    ...
    <div class="row q-col-gutter-lg justify-center">
      ...
      <div class="col-12 col-md-5">
        <q-card flat bordered class="rounded-20 q-pa-lg bg-white shadow-1">
          <div class="text-subtitle1 text-green-10 text-weight-bolder q-mb-lg flex items-center">
          ...
          <div class="q-gutter-y-md">
            ...
            >
              <template v-slot:prepend><q-icon name="warehouse" color="green-9" /></template>
              <template v-slot:hint>Gudang yang stoknya akan dipotong saat disetujui.</template>
            </q-select>

            <div class="row justify-center q-my-sm">
              <q-icon name="south" color="green-10" size="md" class="animate-bounce" />
            </div>
            ...
            <q-input
              ...
              stack-label
            >
              <template v-slot:prepend><q-icon name="input" color="green-10" /></template>
        ...
        <!-- Preview Status -->
        <div class="q-mt-lg q-pa-lg bg-green-1 rounded-20 border-dashed-green text-center">
          <div class="text-overline text-green-10 uppercase tracking-widest">Status Dokumen</div>
          <div class="text-h5 text-weight-bolder text-green-10 uppercase">Waiting Approval</div>
      ...
      <div class="col-12 col-md-7">
        <q-card flat bordered class="rounded-20 bg-white shadow-1 overflow-hidden">
          <q-toolbar class="bg-green-10 text-white q-py-sm">
          ...
          <q-card-section class="q-pa-none">
            <q-markup-table flat separator="horizontal" class="permintaan-table">
              <thead>
                <tr class="bg-grey-1 text-green-10">
                  <th width="50">NO</th>
...
const fetchData = async () => {
  try {
    ...
    const qProyek = query(collection(db, 'proyek_manufaktur'))
    ...
    const qBarang = query(collection(db, 'master_barang_manufaktur'), orderBy('nama', 'asc'))
