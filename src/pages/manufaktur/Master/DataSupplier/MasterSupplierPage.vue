        ...
        <q-card-section class="q-py-md">
          <div class="row items-center q-col-gutter-md">
            ...
            <div class="col-12 col-md-auto text-caption text-grey-6">
              Total Vendor:
              <span class="text-weight-bold text-teal-10">{{ rows.length }} Perusahaan</span>
            </div>
          </div>
        </q-card-section>
      </q-card>
              ...
              >
                <div class="row items-center">
                  ...
                  <div class="col-12 col-md-8 q-pa-xl">
                    <div class="text-h3 text-weight-bolder text-teal-10 q-mb-xs uppercase">
              ...
              <div class="row q-col-gutter-xl">
                    ...
                    <q-card-section class="q-pa-lg">
                      <div class="q-gutter-y-lg">
                        <div class="row">
                          ...
                          <div class="col-8 text-weight-bolder text-teal-10">
                    ...
                    <q-card-section class="q-pa-lg">
                      <div class="q-gutter-y-md">
                        ...
                        <div class="row items-center">
                          ...
                          <div class="col-8 text-weight-bold text-teal-10">
                ...
                <div class="col-12">
                  <q-card flat bordered class="rounded-20 shadow-sm bg-white overflow-hidden">
                    <q-card-section class="bg-teal-10 text-white text-weight-bold uppercase">
              ...
              <div class="row q-col-gutter-xl">
                ...
                <div class="col-12 col-md-6">
                  ...
                  <q-card flat bordered class="rounded-20 q-pa-lg bg-white shadow-1 q-mt-lg">
                    <div
                      class="text-subtitle1 text-teal-10 text-weight-bolder q-mb-md flex items-center"
                    >
...
const canAction = (actionType) => {
  ...
  const targetId = '_manufaktur_master_supplier'
...
const processHybridUpload = async (file, pathName) => {
  ...
  if (file.size <= 512000) {
    ...
    const sRef = storageRef(storage, `manufaktur/master/supplier/legal/${Date.now()}_${pathName}`)
...
const simpanSupplier = async () => {
  ...
  try {
    ...
    delete payload.id
    if (isEditMode.value) {
      await updateDoc(doc(db, 'manufactur_master_supplier', docId), payload)
    } else {
      payload.createdAt = serverTimestamp()
      payload.createdBy = authStore.user?.email || authStore.user?.nama || 'system'
      await addDoc(collection(db, 'manufactur_master_supplier'), payload)
    }
...
const confirmHapus = (r) => {
  $q.dialog({
    ...
    try {
      await deleteDoc(doc(db, 'manufactur_master_supplier', r.id))
...
onMounted(() => {
  ...
  const qSupplier = query(collection(db, 'manufactur_master_supplier'), orderBy('createdAt', 'desc'))
