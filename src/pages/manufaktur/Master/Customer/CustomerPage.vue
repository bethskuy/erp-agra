        ...
        <q-card-section class="q-py-md">
          <div class="row items-center q-col-gutter-md">
            ...
            <div class="col-12 col-md-auto text-caption text-grey-6">
              Total Customer:
              <span class="text-weight-bold text-teal-10">{{ rows.length }} Entitas</span>
            </div>
          </div>
        </q-card-section>
      </q-card>
        ...
        <q-card-section class="col scroll q-pa-xl">
          <div class="row justify-center">
            <div class="col-12 col-lg-10">
              ...
              >
                <div class="row">
                  <div class="col-12 col-md-4 bg-teal-1 flex flex-center q-pa-xl">
                    <q-avatar
                      size="150px"
                      color="teal-10"
                      text-color="white"
...
const canAction = (actionType) => {
  ...
  const targetId = '_manufaktur_marketing_customer'
...
const processHybridUpload = async (file, pathName) => {
  ...
  if (file.size <= 512000) {
    ...
    const sRef = storageRef(storage, `manufaktur/master/customer/docs/${Date.now()}_${pathName}`)
