      ...
      <div class="row items-center justify-between q-mb-lg no-print animate-fade-in">
        <div class="col-12 col-md-8">
          <div class="row items-center q-mb-xs">
            ...
            <h4 class="text-h4 text-weight-black text-blue-grey-10 q-ma-none letter-spacing-tight">
              {{ projectSetup.nama || 'Absensi Pekerja Harian' }}
            </h4>
          </div>
          <div class="text-subtitle1 text-blue-grey-6 q-mt-sm line-height-normal font-mono text-xs">
            <q-icon name="tag" class="q-mr-xs" /> KODE: {{ projectSetup.kode || 'BELUM DI-SETUP' }}
            ...
            <div class="col-12 col-md-4">
              <q-card flat class="bento-card bg-white q-pa-lg shadow-soft full-height">
                ...
                <div class="text-caption text-blue-grey-6 leading-relaxed">
                  ...
                  >
                    Upah = (Hadir × Upah Pokok × Koef) + (Setengah × Upah Pokok × Koef × 0.5) + (Jam
                    Lembur × Rate Lembur)
                  </div>
          ...
          >
            ...
            <div class="bg-slate-50 q-pa-md row items-center justify-between border-bottom">
              <div class="row items-center">
                <q-avatar
                  :style="{ backgroundColor: getMandorColor(mi) + '22', color: getMandorColor(mi) }"
                  size="40px"
                  font-size="20px"
                ...
                <table class="abs-tbl">
                  ...
                  <tbody>
                    <tr v-for="(p, pi) in m.pekerja" :key="'row-abs-' + p.id">
                      ...
                      <td>
                        <div class="text-weight-bold text-blue-grey-9 uppercase">{{ p.nama }}</div>
        ...
        <q-tab-panel name="rekap" class="q-pa-none">
          ...
          <div v-if="reportGenerated" class="row q-col-gutter-md q-mb-lg animate-fade-in">
            ...
            <div class="col-12 col-sm-6 col-md-3">
              ...
              >
                <div class="text-overline text-red-8 font-bold uppercase tracking-wide font-medium">
                  Mangkir (Alpha)
                </div>
                ...
                <table class="rekap-tbl">
                  ...
                  <tbody>
                    <tr v-for="(rp, rpi) in rm.pekerja" :key="'rep-p-' + rp.id">
                      ...
                      <td class="text-center font-mono font-bold text-cyan-6">{{ rp.setengah }}</td>
                  ...
                  <tfoot>
                    <tr class="rekap-foot">
                      <td colspan="3" class="q-pa-md uppercase text-blue-grey-8 text-weight-black">
